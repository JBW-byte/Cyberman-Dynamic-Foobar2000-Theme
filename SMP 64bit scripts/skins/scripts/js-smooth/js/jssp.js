...
images = {
	path: (fb.ProfilePath + "skins\\scripts\\js-smooth\\images\\"),
	glass_reflect: null,
	loading_angle: 0,
	loading_draw: null,
	noart: null,
...
function get_colors() {
	...
	arr = window.GetProperty("CUSTOM COLOR TEXT NORMAL", "255-250-250").split("-");
	g_color_normal_txt = RGB(arr[0], arr[1], arr[2]);
	arr = window.GetProperty("CUSTOM COLOR TEXT SELECTED", "255-250-250").split("-");
	...
	arr = window.GetProperty("CUSTOM COLOR BACKGROUND SELECTED", "255-250-250-125").split("-");
	// Using RGBA format for transparency, the last value (100) is the alpha channel
