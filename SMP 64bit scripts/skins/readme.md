...
# Installation
<br>
Make a folder called skins and place my scripts in the correct location, download my files and place them in skins keeping any folder structures.<br> or download scripts_extra.zip from main theme page and extract to profile folder<br>
