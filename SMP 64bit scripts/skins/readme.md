...
Simple sensible right click options. For larger panels and FPS increase, to change the values near the top of the script, MAX_IMAGE_SIZE and timerInterval.<br>
