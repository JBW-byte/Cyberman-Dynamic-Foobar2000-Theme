...
* VolumeKnob: **Updated* 26 Feb 26, Simple functionality, Hold left mouse and drap up or down to change volume, double click mute, right click themes, non-linear volume control. Could probably be adapted to any type of Knob.<br>

* PanelArt: ***Updated* 26 Feb 26, Simple Track display and album art background blur/darkness. Multiple Layouts vert./hori. several options in right click menu. A lot of customization. Dbl click for a random image or right click for a slide show, if you have set up an image folder for .jps .png ect.. 
Custom file paths working fairly well, probably. Requires album art to look its best<br><br>
