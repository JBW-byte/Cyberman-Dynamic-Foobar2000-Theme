...
Simple sensible right click options. For larger panels and FPS increase, change the values near the top of the script, MAX_IMAGE_SIZE and timerInterval.<br><br>
Performance ok now on larger panels with the default settings, updated script.
