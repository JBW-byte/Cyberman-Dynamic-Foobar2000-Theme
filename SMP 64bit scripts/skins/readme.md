...
Custom **Spider Monkey Panel / JSplitter scripts** designed for **Foobar2000 v2** providing animated visuals, album-art driven UI elements, and interactive controls.
