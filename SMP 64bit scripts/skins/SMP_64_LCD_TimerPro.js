...
window.DefineScript('SMP 64bit LCD TimerPro 1.4', { author: 'L.E.D.', options: { grab_focus: true } });
...
if (showScanlines || showPhosphor) {
    ...
    try {
        // 1. FIRST: Draw the Smooth Phosphor (The Background Glow)
    ...
    // ---- Reflection: Ported Option 1 (No Banding) ----
    if (useReflection && opReflection > 0) {
        ...
        try {
            ...
            // DRAW EVERY ROW INDIVIDUALLY to eliminate banding
